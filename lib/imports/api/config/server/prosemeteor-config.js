...
class ProseMeteorConfig {
  constructor () {
    ...
    this._docActivityTimeoutMs = undefined;
  }
  ...
  set failedHealthChecksThreshold (value) {
    this.checkExists('failedHealthChecksThreshold', value);
    if (value < 3) {
  ...
  get docActivityTimeoutMs () {
    return this._docActivityTimeoutMs;
  }
  set docActivityTimeoutMs (value) {
    this.checkExists('docActivityTimeoutMs', value);
    this._docActivityTimeoutMs = value;
  }
