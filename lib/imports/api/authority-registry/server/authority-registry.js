...
export class AuthorityRegistry {
  ...
  */
  removeDocFromAuthorityServer ({ docId, groupId = null }) {
    ...
    const removeResult = removeDocFromAuthorityServer.call({ docId, groupId, fullUrl: this.fullUrl });
    console.log(`ProseMeteor AuthorityRegistry: Removed doc ${docId} from authority ${this.fullUrl}. Removed groupId = ${removeResult.groupIdRemoved}. Updated registry: ${JSON.stringify(this.fullRegistry(), null, 2)}`);
  }
  /**
