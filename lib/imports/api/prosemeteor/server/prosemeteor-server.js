...
export class ProseMeteorServer {
  ...
  */
  constructor ({
    ...
    if (typeof authentication.canUserViewDoc !== 'function') {
      console.log('--auth hook: using default for canUserViewDoc');
    }
    if (typeof authentication.canUserEditDoc !== 'function') {
      console.log('--auth hook: using default for canUserEditDoc');
    }
    if (typeof authentication.canUserDeleteDoc !== 'function') {
      console.log('--auth hook: using default for canUserDeleteDoc');
    }
