import { ProseMeteorAuthority } from './authority';

export class ProseMeteorAuthorityManager {
  constructor(documentCollection, streamerServer) {
  ...
  openDoc(docId) {
    ...
    console.log('ProseMeteorAuthorityManager opening doc ' + docId + ', creating new authority');

    // create a new authority
    this.authorities[docId] = new ProseMeteorAuthority(docId, this.documentsCollection, this.streamerServer);
...
//     this.authorities[docId] = new ProseMeteorAuthority(docId, this.documentsCollection);
