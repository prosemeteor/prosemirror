...
export class AuthorityManager {
  ...
  */
  constructor ({ documentsColl, streamer }) {
    ...
    this.removeAuthorityFromMemory = this.removeAuthorityFromMemory.bind(this);
  ...
  */
  ...
  removeAuthorityFromMemory ({ docId }) {
    if (typeof this.authorities[docId] === 'undefined') {
      throw new Meteor.Error('no-authority-exists', `removeAuthorityFromMemory: This AuthorityManager doesn't have an Authority tracking a document with docId ${docId}.`);
    }
